...
```bash
curl -fsSL https://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@raw.githubusercontent.com/Soluk-GBS/ProjektM158-169/main/setup.sh | bash
```
